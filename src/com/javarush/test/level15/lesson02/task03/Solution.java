...
public class Solution {
    ...
    public static class Ferrari extends LuxuriousCar {
        public void printlnDesire() {
            System.out.println(Constants.WANT_STRING.concat(Constants.FERRARY_NAME));
        }
    }

    public static class Lanos extends CheapCar {
        public void printlnDesire() {
            System.out.println(Constants.WANT_STRING.concat(Constants.LANOS_NAME));
        }
    }
    public static class LuxuriousCar
    {
        protected void printlnDesire() {
            System.out.println(Constants.WANT_STRING.concat(Constants.LUXURIOUS_CAR));
        }
    }
    ...
    {
        void printlnDesire() {
            System.out.println(Constants.WANT_STRING.concat(Constants.CHEAP_CAR));
        }
    }
