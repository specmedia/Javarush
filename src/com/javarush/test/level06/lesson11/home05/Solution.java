...
*/
    ...
    public class Solution
    {
        ...
        {
            System.out.println(idea.getDescription());                  // непонимаю что требуют от меня в 3 пункте??
        }

        public static class Idea                  //первый пункт
        {
            public String getDescription()          // второй пункт
            {
                return "Money";
            }
        }
